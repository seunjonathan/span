'''
In this sample, the Flask app object is contained within the rest_app *module*;
that is, rest_app contains an __init__.py along with relative imports. Because
...
from rest_app.webapp import app